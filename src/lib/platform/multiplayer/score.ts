...
export function totals(events: readonly ScoreEvent[]): Record<string, number> { return events.reduce<Record<string, number>>((a,e) => ({ ...a, [e.playerId]: (a[e.playerId] ?? 0) + e.points }), {}); }
