...
export const QA_ITEMS: QAItem[] = [
  ...
  ["payments","Blockchain payment URI","Wallet-compatible payment URI is generated from server-controlled chain and recipient data."],
  ["payments","Blockchain payment request expiry","A payment request expires and cannot be reused after its deadline."],
  ["payments","Blockchain cancellation","A pending payment intent can be safely cancelled without granting entitlement."],
  ["payments","Blockchain network health","Configured RPC health can be checked without exposing RPC credentials."],
  ["payments","Blockchain explorer link","Verified/pending transactions can be opened in the correct chain explorer."],
  ["payments","Blockchain multi-chain catalog","Each enabled network uses its own treasury, confirmations and optional token contract."],
  ["payments","Blockchain token isolation","An ERC-20 payment on one network cannot satisfy an intent for another token/network."],
  ["payments","Blockchain reorg safety","Access is not granted from an unconfirmed/reorg-risk transaction state."],
  ["payments","Blockchain treasury isolation","Treasury addresses are server-side configuration and are never writable by the client."],
  ["payments","Blockchain secret isolation","RPC credentials and treasury signing keys are never required in the browser."],
  ["payments","Blockchain audit trail","Payment status transitions and verified receipts remain queryable for support/audit."],
