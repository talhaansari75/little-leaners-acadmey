...
export const QA_ITEMS: QAItem[] = [
  ...
  ["payments","Blockchain wallet connection","EVM wallet connection works without exposing private keys."],
  ["payments","Blockchain chain allowlist","Only server-configured chain IDs are accepted."],
  ["payments","Blockchain recipient enforcement","Client cannot change the server-configured treasury recipient."],
  ["payments","Blockchain exact amount","Server rejects underpayment and overpayment."],
  ["payments","Blockchain native transfer","Native-asset payment is verified from the transaction value."],
  ["payments","Blockchain ERC-20 transfer","ERC-20 Transfer logs are verified against token, sender and recipient."],
  ["payments","Blockchain confirmation depth","Access is not granted until required confirmations are reached."],
  ["payments","Blockchain failed transaction","Reverted/failed transactions never grant entitlement."],
  ["payments","Blockchain expired intent","Expired payment intents cannot be completed."],
  ["payments","Blockchain replay protection","The same transaction hash cannot grant access twice."],
  ["payments","Blockchain wallet mismatch","A transaction from a different wallet is rejected."],
  ["payments","Blockchain network mismatch","A transaction on another chain is rejected."],
  ["payments","Blockchain payment history","Verified and pending blockchain payments appear in history."],
  ["payments","Blockchain entitlement atomicity","Payment record and entitlement are committed together."],
  ["payments","Blockchain testnet mode","QA can use Sepolia without production treasury funds."],
  ["payments","Blockchain RPC failure","RPC failures return a safe retryable error."],
  ["payments","Blockchain no-secret client","No treasury/private-key secret is shipped to the browser."],
  ["payments","Blockchain one-time purchase","Crypto checkout does not falsely present a recurring subscription."],
