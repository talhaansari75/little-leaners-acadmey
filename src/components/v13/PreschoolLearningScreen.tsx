...
const ACTIVITIES: Activity[] = [
 ...
 {id:"class1-writing",title:"Language Shelf",subtitle:"Objects, sounds & tracing",icon:<Pencil className="size-6"/>,kind:"tracing",world:"abc",classes:["Class 1"]},
 {id:"class1-math",title:"Montessori Mathematics",subtitle:"Quantity & number sense",icon:<Calculator className="size-6"/>,kind:"math",premium:true,world:"math",classes:["Class 1"]},
