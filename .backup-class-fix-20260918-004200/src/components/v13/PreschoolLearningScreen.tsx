...
const ACTIVITIES: Activity[] = [
 ...
 {id:"kg-phonics",title:"Phonics Builder",subtitle:"Sounds, letters & CVC",icon:<BookOpen className="size-6"/>,kind:"letters",world:"abc",classes:["KG-1"]},
 {id:"kg-math",title:"Math Mountain",subtitle:"Add, compare & count",icon:<Calculator className="size-6"/>,kind:"math",premium:true,world:"math",classes:["KG-1"]},
 {id:"kg-patterns",title:"Pattern Detective",subtitle:"Find what comes next",icon:<Sparkles className="size-6"/>,kind:"patterns",premium:true,world:"math",classes:["KG-1"]},
 ...
 {id:"class1-science",title:"Science Explorer",subtitle:"Discover the world",icon:<Car className="size-6"/>,kind:"vehicles",world:"nature",classes:["Class 1"]},
 {id:"mont-language",title:"Language Shelf",subtitle:"Objects, sounds & tracing",icon:<Pencil className="size-6"/>,kind:"tracing",world:"abc",classes:["Class 1"]},
 {id:"mont-math",title:"Montessori Mathematics",subtitle:"Quantity & number sense",icon:<Calculator className="size-6"/>,kind:"math",premium:true,world:"math",classes:["Class 1"]},
 {id:"mont-sensorial",title:"Sensorial Studio",subtitle:"Color & shape grading",icon:<Shapes className="size-6"/>,kind:"shapes",world:"creative",classes:["Class 1"]},
 {id:"mont-sorting",title:"Sorting Station",subtitle:"Classify, order & compare",icon:<Star className="size-6"/>,kind:"sorting",world:"games",classes:["Class 1"]},
 {id:"mont-practical",title:"Practical Life",subtitle:"Hands-on daily routines",icon:<Heart className="size-6"/>,kind:"sorting",world:"games",classes:["Class 1"]},
 {id:"mont-nature",title:"Nature Corner",subtitle:"Listen and discover nature",icon:<Volume2 className="size-6"/>,kind:"listen",premium:true,world:"nature",classes:["Class 1"]},
 {id:"mont-worksheets",title:"Worksheet Table",subtitle:"Calm independent practice",icon:<Pencil className="size-6"/>,kind:"tracing",world:"abc",classes:["Class 1"]},
];
