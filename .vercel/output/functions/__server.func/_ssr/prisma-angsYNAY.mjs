import { i as withTransaction, r as getSql } from "./db-Z7x1Txqi.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/prisma-angsYNAY.js
...
var MODELS = {
	...
	legalConsent: {
		...
		dates: ["acceptedAt"],
		uniques: { userId_version: ["userId", "version"] }
	},
	role: {
		table: "roles",
		uniques: {
